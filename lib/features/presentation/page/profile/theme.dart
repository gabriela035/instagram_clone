...
import 'package:instagram_clone/features/presentation/page/profile/widgets/change_theme_button_widget.dart';
            ...
            body: Column(children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Switch.adaptive(
                    value:
                        _lightDarkModeEnabled && _themeMode == ThemeMode.dark,
                    onChanged: (value) {
                      setState(() {
                        _systemSwitch = false;
